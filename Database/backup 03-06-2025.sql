...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 03. Jun 2025 um 10:34
...
INSERT INTO `mieter` (`ID`, `name`, `nachname`, `telefonnummer`, `email`, `username`, `passwort`, `isAdmin`) VALUES
(1, 'Martin', 'Matratze', 12346789, 'poco.domaene@gmail.com', 'gleggmire', NULL, 1),
(2, 'Samuel', 'Autohaus', 1234567899, 'auto.samuel@poco.de', NULL, NULL, 0),
(3, 'Thomas', 'Berger', 2147483647, 'thomas.berger@example.com', NULL, NULL, 0),
(4, 'Julia', 'Krause', 2147483647, 'julia.krause@example.com', NULL, NULL, 0),
(5, 'Daniel', 'Meier', 2147483647, 'daniel.meier@example.com', NULL, NULL, 0),
(6, 'Nina', 'Schmidt', 2147483647, 'nina.schmidt@example.com', NULL, NULL, 0),
(7, 'Sebastian', 'Vogel', 2147483647, 'sebastian.vogel@example.com', NULL, NULL, 0),
(8, 'Kathrin', 'Horn', 2147483647, 'kathrin.horn@example.com', NULL, NULL, 0),
(9, 'Andreas', 'Bauer', 2147483647, 'andreas.bauer@example.com', NULL, NULL, 0),
(10, 'Melanie', 'Jansen', 2147483647, 'melanie.jansen@example.com', NULL, NULL, 0),
(11, 'Stefan', 'Graf', 2147483647, 'stefan.graf@example.com', NULL, NULL, 0),
(12, 'Vanessa', 'Lorenz', 2147483647, 'vanessa.lorenz@example.com', NULL, NULL, 0),
(13, NULL, NULL, NULL, 'webtester.test@gmail.com', NULL, NULL, 0),
(14, 'peter', 'faust', 133908395, 'test2@gmail.com', 'test2', '1234567', 0),
(15, '123', '123', 123, '123@dd.de', '123', '123', 0),
(16, 'test', 'tester', 123456789, 'test@gmsil.com', 'test3', '123', 0),
(17, 'test', 'tester', 1246432, 'test7@gmail.com', 'tester7', '123', 0),
(18, 'test', 'maier', 1246334, 'tester.10@gmail.com', 'tester10', '123', 0),
(19, 'Jens ', 'Heddrich', 1719939553, 'jens.heddrich@konrad-zuse-schule.de', 'Beckenbauer', 'Konrad', 0),
(20, 'hans', 'peter', 134564545, 'hans@gmail.com', 'Hans', '123', 0),
(21, 'niklas', 'arz', 12363627, 'nikla@gmial.com', 'niklas', '123', NULL),
(22, 'no', 'admin', 292973428, 'noAdmin@gmail.com', 'noAdmin', '123', 0);
...
(34, 6, 19, 'fussball', '2025-06-13 12:30:00', '2025-06-13 14:30:00'),
(35, 2, 20, 'fussball', '2025-06-04 19:30:00', '2025-06-12 21:30:00');
